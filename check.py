...
TEXT_EXT = {".py", ".md", ".yaml", ".yml", ".tsv", ".conf", ".sh", ".txt",
            ...
            ".cpp", ".h", ".c", ".bat", ".def", ".rc", ".ps1", ".manifest"}
...
# Binaries never ship in this repository: build artifacts are produced by
# build.bat, and memory images or captures of the game are private data.
BANNED_EXT = {".pml", ".ang", ".pcb", ".slc", ".p2s", ".pms", ".dat",
              ".woff", ".woff2", ".ttf", ".otf", ".dll", ".exe", ".bin",
              ".obj", ".map", ".pyc", ".log"}
...
SALT = b"openlobby-denylist-v1:"  # shared with the server repos
DENY_HASHES = {
